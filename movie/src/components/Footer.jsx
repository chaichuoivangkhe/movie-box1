...
const Footer = () => {
  return (
    <div>
      ...
      {/* Thay đổi sang một màu xanh hợp hơn */}
      <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#1E3A8A] to-[#0F172A] text-white/70">
        ...
        <p className="mt-4 text-center">Copyright © 2025 <a href="https://prebuiltui.com">MovieBox</a>. All rights reservered.</p>
        <div className="flex items-center gap-4 mt-5">
          <a href="https://www.facebook.com/profile.php?id=61578334508125" className="hover:-translate-y-0.5 transition-all duration-300">
